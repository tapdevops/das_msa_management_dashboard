...
exports.getAFD = async (req, res) => {
    ...
    var query = `
        SELECT * FROM ${process.env.ORACLE_SCHEME}.DAS_AFD_TONASE_PRODUKSI_MV
...
exports.getBlok = async (req, res) => {
    ...
    var query = `
        SELECT * FROM ${process.env.ORACLE_SCHEME}.DAS_BLOK_TONASE_PRODUKSI_MV
...
exports.getCompany = async (req, res) => {
    ...
    var query = `
        SELECT * FROM ${process.env.ORACLE_SCHEME}.DAS_COM_TONASE_PRODUKSI_MV
...
exports.getEstate = async (req, res) => {
    ...
    var query = `
        SELECT * FROM ${process.env.ORACLE_SCHEME}.DAS_EST_TONASE_PRODUKSI_MV
        WHERE WERKS = '${werks}'
    `;
    functions.fetch(query, res);
}