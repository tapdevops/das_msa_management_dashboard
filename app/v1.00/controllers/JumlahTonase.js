...
exports.getAFD = async (req, res) => {
    ...
    var query = `
        SELECT * FROM ${process.env.ORACLE_SCHEME}.DASMAP_CHARTLINE_AFD_MV
...
exports.getBlok = async (req, res) => {
    ...
    var query = `
        SELECT * FROM ${process.env.ORACLE_SCHEME}.DASMAP_CHARTLINE_BLOCK_MV
...
exports.getCompany = async (req, res) => {
    ...
    var query = `
        SELECT * FROM ${process.env.ORACLE_SCHEME}.DASMAP_CHARTLINE_COMP_MV
...
exports.getEstate = async (req, res) => {
    ...
    var query = `
        SELECT * FROM ${process.env.ORACLE_SCHEME}.DASMAP_CHARTLINE_EST_MV
        WHERE WERKS = '${werks}'
    `;
    functions.fetch(query, res);
}